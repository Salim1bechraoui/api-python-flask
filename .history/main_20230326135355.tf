...
resource "github_repository" "api-python-flask
" {
...
resource "github_branch_default" "main" {
  branch     = "main"
  repository = github_repository.api-python-flask
.name
}
...
resource "aws_instance" "tf-docker" {
  ...
  user_data  = <<-EOF
    ...
    TOKEN="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"
    FOLDER="https://$TOKEN@raw.githubusercontent.com/Salim1bechraoui/api-python-flask
/main/"
  ...
  depends_on = [github_repository.api-python-flask
